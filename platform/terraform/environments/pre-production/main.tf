...
// Service account used by application projects (AI, HitL) to provision and deploy
...
// Delegate limited ability to grant roles on the project
  ...
  condition {
    ...
    expression = join(
      ...
      [
        ...
        ".hasOnly(['roles/cloudsql.instanceUser', 'roles/cloudsql.client'])"
      ]
    )
  }
}
